...
function populateFigures() {
    ...
    if (figureCount === 3) {
        ...
        for (var i = 0;i < 5; i+++) {
            filename = "images/IMG_0" + photoOrder[i] + "sm.jpg";
            currentFig = document.getElementsByTagName("imgs")[i];
            currentFig.src = filename;
        }//end of for loop
    }//end of else
...
function previewFive() {
    ...
    //create figure and img elelments for fifth image
...
function createEventListeners() {
   ...
   //declare variable for dicument element with the id of the rightarrow in the html document
   ...
   //declare a variable for the elemnet fiveButton
